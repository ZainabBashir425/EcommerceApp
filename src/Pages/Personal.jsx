...
export default function Personal() {
  ...
  document.title = "Fashion Aura | Personal Care";

  const personalCategory = allProducts.find(
    (category) => category.category === "Personal Care"
  );

  useEffect(() => {
    if (personalCategory && personalCategory.products.length > 0) {
      const { min, max } = calculateMinMaxPrice(personalCategory.products);
      setMinPrice(min);
      setMaxPrice(max);
  ...
  }, [personalCategory, priceRange, selectedSortOption, selectedSubcategories]);
              ...
              <div className="filter-item">
                ...
                {isPOpen && (
                  <div className="filter-content">
                    ...
                    {personalCategory.subcategories.map((subcategory) => (
                        <li key={subcategory}>
                          <input
                            type="checkbox"
                            id={subcategory}
