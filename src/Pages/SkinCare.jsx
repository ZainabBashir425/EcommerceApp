...
export default function SkinCare() {
  ...
  document.title = "Fashion Aura | Skin Care";

  const skinCareCategory = allProducts.find(
    (category) => category.category === "Skin Care"
  );

  useEffect(() => {
    if (skinCareCategory && skinCareCategory.products.length > 0) {
      const { min, max } = calculateMinMaxPrice(skinCareCategory.products);
      setMinPrice(min);
      setMaxPrice(max);
  ...
  }, [skinCareCategory, priceRange, selectedSortOption, selectedSubcategories]);
              ...
              <div className="filter-item">
                ...
                {isPOpen && (
                  <div className="filter-content">
                    ...
                    {skinCareCategory.subcategories.map((subcategory) => (
                        <li key={subcategory}>
                          <input
                            type="checkbox"
                            id={subcategory}
